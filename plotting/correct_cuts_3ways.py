...
fin = "../../CASEUtils/jet_images/Bkg_JetImages/QCD2016APV1500to2000.h5" #signal we're testing
...
#Signal Loose masses cut and VAE
LMjj = tot_mjj[loose_boolean]
Lmj1 = tot_mj1[loose_boolean]
Lmj2 = tot_mj2[loose_boolean]
...
np.savetxt("Bkg/Loose/"+name+"_Mjj_BKG.csv", LMjj, delimiter=",")
np.savetxt("Bkg/Loose/"+name+"_mj1_BKG.csv", Lmj1, delimiter=",")
np.savetxt("Bkg/Loose/"+name+"_mj2_BKG.csv", Lmj2, delimiter=",")
