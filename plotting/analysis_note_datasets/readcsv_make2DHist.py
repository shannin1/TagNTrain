...
for process in processes:
        f = ROOT.TFile('2dhistos_scaled/{}_CR.root'.format(process),'recreate')
        f.cd()
        ...
        for sys_weight in sys_weights_map:
                ...
                passname = 'PmjjvsPmY_CR_pass_{}'.format(weightname)
                loosename = 'LmjjvsLmY_CR_loose_{}'.format(weightname)
                failname = 'FmjjvsFmY_CR_fail_{}'.format(weightname)        
