...
for i in range(num_batches):
    ...
    temp_sig_score1 =  np.mean(np.square(reco_signal1 - imgs), axis=(1,2)).reshape(-1)
    temp_sig_score2 =  np.mean(np.square(reco_signal2 - imgs2), axis=(1,2)).reshape(-1)
...
sig_score1 = sig_score1
sig_score2 = sig_score2
